...
--output_name output/softmax --num_classes 12 --train_dir work/v1/DpNet2Model/DPNET-1.0_0_adam_l2 \
...
--optimizer adam DpNet2Model --weight_decay 0 --width_multiplier 1.0 &
sleep 5
...
--checkpoint_path work/v1/DpNet2Model/DPNET-1.0_0_adam_l2 \
...
--valid_type loop DpNet2Model --weight_decay 0 --width_multiplier 1.0 &
wait
...
--checkpoint_path work/v1/DpNet2Model/DPNET-1.0_0_adam_l2/valid/accuracy/valid \
--num_silent 257 --augmentation_method anchored_slice_or_pad \
--background_frequency 0.0 --background_max_volume 0.0 --max_step_from_restore 30000 --batch_size 16 --no-shuffle \
--valid_type once DpNet2Model --weight_decay 0 --width_multiplier 1.0
